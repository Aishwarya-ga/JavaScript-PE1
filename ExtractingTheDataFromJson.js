/*You need to create a program that extracts data from the preceding JSON 
...
var jsonObject= {
    ...
    //getting only articles from entire object
    var article=jsonObject["articles"];
    
    //iterating through each keys of article
    Object.keys(article).forEach(function(item) {

       // The delete keyword deletes a property from an object:
        delete article[item].url;  
        delete article[item].urlToImage;
        delete article[item].publishedAt
    });
    console.log(article);